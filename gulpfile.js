...
function scripts() {
  return src(["app/js/**/*.js", "!app/js/**/*.min.js", "!app/js/**/*.biz.js"])
    .pipe(
      webpack({
        mode: "development",
...
function startwatch() {
  ...
  watch(["app/js/**/*.js", "!app/js/**/*.min.js", "!app/js/**/*.biz.js"], { usePolling: true }, scripts);
  watch(["!app/js/**/*.js", "!app/js/**/*.min.js", "app/js/**/*.biz.js"], { usePolling: true }, bizScripts);
  watch("app/images/src/**/*.{jpg,jpeg,png,webp,svg,gif}", { usePolling: true }, images);
  watch(`app/**/*.{${fileswatch}}`, { usePolling: true }).on("change", browserSync.reload);
}

exports.scripts = scripts;
exports.bizScripts = bizScripts;
